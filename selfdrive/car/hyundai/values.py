...
class CarControllerParams:
  ...
  def __init__(self, CP):
    ...
    elif CP.carFingerprint in (CAR.GENESIS_G80, CAR.GENESIS_G90, CAR.ELANTRA, CAR.K7, CAR.IONIQ,
...
CAN_GEARS = {
  ...
  "use_cluster_gears": {CAR.ELANTRA, CAR.KONA, CAR.K7},
...
LEGACY_SAFETY_MODE_CAR = {CAR.HYUNDAI_GENESIS, CAR.IONIQ_EV_2020, CAR.IONIQ_EV_LTD, CAR.IONIQ_PHEV, CAR.IONIQ, CAR.KONA_EV, CAR.KIA_SORENTO, CAR.SONATA_LF, CAR.KIA_OPTIMA_G4, CAR.KIA_OPTIMA_G4_FL, CAR.VELOSTER,
                          CAR.GENESIS_G70, CAR.GENESIS_G80, CAR.KIA_CEED, CAR.K7, CAR.ELANTRA, CAR.IONIQ_HEV_2022}
